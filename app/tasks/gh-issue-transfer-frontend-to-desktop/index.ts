 ...
 *
 * Workflow:
 * 1. Fetch new/unseen issues from the frontend repository with label "desktop"
 * 2. For each issue:
 *    1. Create corresponding issues in the desktop repository, copying title, body (+meta and backlinks), labels, assignees
